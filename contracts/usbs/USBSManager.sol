...
import "contracts/usbs/blocklist/BlocklistClient.sol";
import "contracts/sanctions/SanctionsListClient.sol";
import "contracts/interfaces/IUSBSManager.sol";

contract USBSManager is
  ...
  IUSBSManager
{
   ...
   *         at which a user can claim their USBS
   *
   ...
   *      once USBS-specific checks have been made
   */
